...
public class LedgerDeviceBLE implements LedgerDevice {
  ...
  public final BluetoothGatt connection;
   ...
   */  
  public LedgerDeviceBLE(BluetoothGatt connection, int timeoutMS, int maxMTU, BluetoothDevice device) {
   ...
   * @param connection Connection to the device GATT service established by the caller
   */
  public LedgerDeviceBLE(BluetoothGatt connection, BluetoothDevice device) {
    this(connection, DEFAULT_TIMEOUT_MS, DEFAULT_MAX_MTU, device);
  }
