...
export interface InitOutput {
  ...
  readonly closure11074_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure11116_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure11825_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure12004_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure11923_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen_4be2b48c741033d9___convert__closures_____invoke______21: (a: number, b: number) => void;
  readonly closure12020_externref_shim: (a: number, b: number, c: any, d: any) => void;
