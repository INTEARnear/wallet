import{a as P}from"./chunk-PPLSOLUM.js";import{a as $}from"./chunk-B2LU4KHT.js";import{r as b,v as C,w as z,z as x}from"./chunk-RZQOM5QR.js";import{a as m,b as S}from"./chunk-IDZGCU4F.js";import{e,k as y}from"./chunk-ZS2R6O6N.js";import{O,S as h}from"./chunk-OXOEMY67.js";import{i as s,k as l,o as c}from"./chunk-JY5TIRRF.js";s();c();l();s();c();l();var _=b`
  :host {
    display: block;
  }
...
`;var I=function(t,i,r,o){var n=arguments.length,a=n<3?i:o===null?o=Object.getOwnPropertyDescriptor(i,r):o,w;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,o);else for(var p=t.length-1;p>=0;p--)(w=t[p])&&(a=(n<3?w(a):n>3?w(i,r,a):w(i,r))||a);return n>3&&a&&Object.defineProperty(i,r,a),a},W=class extends y{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=h.state.view}firstUpdated(){this.status=P.hasFooter()?"show":"hide",this.unsubscribe.push(h.subscribeKey("view",i=>{this.view=i,this.status=P.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(i=>{for(let r of i)if(r.target===this.getWrapper()){let o=`${r.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",o)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
      <div class="container" status=${this.status}>${this.templatePageContainer()}</div>
    `}templatePageContainer(){return P.hasFooter()?e` ${this.templateFooter()}`:null}templateFooter(){switch(this.view){case"Networks":return this.templateNetworksFooter();case"Connect":case"ConnectWallets":case"OnRampFiatSelect":case"OnRampTokenSelect":return e`<w3m-legal-footer></w3m-legal-footer>`;case"OnRampProviders":return e`<w3m-onramp-providers-footer></w3m-onramp-providers-footer>`;default:return null}}templateNetworksFooter(){return e` <wui-flex
      class="footer-in"
      padding="3"
...
`;var L=function(t,i,r,o){var n=arguments.length,a=n<3?i:o===null?o=Object.getOwnPropertyDescriptor(i,r):o,w;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,o);else for(var p=t.length-1;p>=0;p--)(w=t[p])&&(a=(n<3?w(a):n>3?w(i,r,a):w(i,r))||a);return n>3&&a&&Object.defineProperty(i,r,a),a},R=4,A=class extends y{constructor(){super(...arguments),this.walletImages=[]}render(){let i=this.walletImages.length<R;return e`${this.walletImages.slice(0,R).map(({src:r,walletName:o})=>e`
          <wui-wallet-image
            size="sm"
            imageSrc=${r}
            name=${$(o)}
          ></wui-wallet-image>
        `)}
    ${i?[...Array(R-this.walletImages.length)].map(()=>e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};A.styles=[C,j];L([m({type:Array})],A.prototype,"walletImages",void 0);A=L([x("wui-all-wallets-image")],A);s();c();l();var F=b`
  :host {
    width: 100%;
  }
...
`;var d=function(t,i,r,o){var n=arguments.length,a=n<3?i:o===null?o=Object.getOwnPropertyDescriptor(i,r):o,w;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,o);else for(var p=t.length-1;p>=0;p--)(w=t[p])&&(a=(n<3?w(a):n>3?w(i,r,a):w(i,r))||a);return n>3&&a&&Object.defineProperty(i,r,a),a},D={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:"ton"},u=class extends y{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,e`
      <button
    ...
    `}templateNamespaces(){return this.namespaces?.length?e`<wui-flex alignItems="center" gap="0">
        ...
        name=${this.name}
      ></wui-wallet-image>`:!this.showAllWallets&&!this.imageSrc?e`<wui-wallet-image size="sm" name=${this.name}></wui-wallet-image>`:null}templateStatus(){return this.loading?e`<wui-loading-spinner size="lg" color="accent-primary"></wui-loading-spinner>`:this.tagLabel&&this.tagVariant?e`<wui-tag size="sm" variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`:null}};u.styles=[C,z,F];d([m({type:Array})],u.prototype,"walletImages",void 0);d([m()],u.prototype,"imageSrc",void 0);d([m()],u.prototype,"name",void 0);d([m()],u.prototype,"size",void 0);d([m()],u.prototype,"tagLabel",void 0);d([m()],u.prototype,"tagVariant",void 0);d([m()],u.prototype,"walletIcon",void 0);d([m()],u.prototype,"tabIdx",void 0);d([m({type:Array})],u.prototype,"namespaces",void 0);d([m({type:Boolean})],u.prototype,"disabled",void 0);d([m({type:Boolean})],u.prototype,"showAllWallets",void 0);d([m({type:Boolean})],u.prototype,"loading",void 0);d([m({type:String})],u.prototype,"loadingSpinnerColor",void 0);u=d([x("wui-list-wallet")],u);s();c();l();export{W as a,k as b};
