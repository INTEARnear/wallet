import{a as g,b as c,c as r,d,e as Z,f as s}from"./chunk-NHI5MHIS.js";import{i as V,k as m,o as n}from"./chunk-JY5TIRRF.js";V();n();m();var A=Object.defineProperty,f=Object.getOwnPropertyDescriptor,a=(o,i,H,p)=>{for(var e=p>1?void 0:p?f(i,H):i,h=o.length-1,l;h>=0;h--)(l=o[h])&&(e=(p?l(i,H,e):l(e))||e);return p&&e&&A(i,H,e),e},t=class extends d{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return c`<svg
  ...
  `;a([s({type:String,reflect:!0})],t.prototype,"size",2);a([s({type:String,reflect:!0})],t.prototype,"weight",2);a([s({type:String,reflect:!0})],t.prototype,"color",2);a([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=a([Z("ph-browser")],t);export{t as PhBrowser};
