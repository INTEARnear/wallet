import{a as d,b as M,c as r,d as f,e as u,f as s}from"./chunk-NHI5MHIS.js";import{i as n,k as g,o as m}from"./chunk-JY5TIRRF.js";n();m();g();var y=Object.defineProperty,w=Object.getOwnPropertyDescriptor,o=(a,i,h,p)=>{for(var e=p>1?void 0:p?w(i,h):i,l=a.length-1,c;l>=0;l--)(c=a[l])&&(e=(p?c(i,h,e):c(e))||e);return p&&e&&y(i,h,e),e},t=class extends f{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return M`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([u("ph-user")],t);export{t as PhUser};
