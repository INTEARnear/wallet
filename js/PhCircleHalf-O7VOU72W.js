import{a as g,b as V,c as r,d,e as f,f as o}from"./chunk-NHI5MHIS.js";import{i as n,k as Z,o as c}from"./chunk-JY5TIRRF.js";n();c();Z();var M=Object.defineProperty,y=Object.getOwnPropertyDescriptor,i=(a,s,l,p)=>{for(var e=p>1?void 0:p?y(s,l):s,m=a.length-1,h;m>=0;m--)(h=a[m])&&(e=(p?h(s,l,e):h(e))||e);return p&&e&&M(s,l,e),e},t=class extends d{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return V`<svg
  ...
  `;i([o({type:String,reflect:!0})],t.prototype,"size",2);i([o({type:String,reflect:!0})],t.prototype,"weight",2);i([o({type:String,reflect:!0})],t.prototype,"color",2);i([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=i([f("ph-circle-half")],t);export{t as PhCircleHalf};
