import"./chunk-RBCU3WPG.js";import"./chunk-M2VULRBY.js";import"./chunk-PU35MFV3.js";import"./chunk-YIUCGNHJ.js";import"./chunk-F3XJVLCK.js";import"./chunk-LFU5HR3D.js";import"./chunk-SUQYUI7P.js";import{a as V,b as F}from"./chunk-J6OVQL6H.js";import"./chunk-XZSMYPDE.js";import"./chunk-LO3FIKSF.js";import"./chunk-KBSPKF4N.js";import"./chunk-KVGBKSBS.js";import"./chunk-2RFD6UAP.js";import{a as S,b as x,g as B}from"./chunk-HILJYRBB.js";import{A as k,G as H,I as T,J as U,N as b,U as L,Z as f,b as C,g as j,i as M,j as I,l as A,q as N,s as P,t as O,u as z,z as _}from"./chunk-UDTBWQKV.js";import"./chunk-ETAVA44A.js";import"./chunk-KIG3ADHQ.js";import"./chunk-JK5MJGFP.js";import"./chunk-COAJKL54.js";import"./chunk-65GJ65H6.js";import"./chunk-H6T4G3YK.js";import"./chunk-JBYAY2RL.js";import"./chunk-PIVQIF3J.js";import"./chunk-FILZKAK2.js";import"./chunk-OZZRRPYE.js";import"./chunk-FXML5DPA.js";import"./chunk-6OI5GZ4U.js";import"./chunk-YRGGSJIG.js";import{b as v,e as u,j as p}from"./chunk-5RP2GFJC.js";import{h as a,j as l,n as m}from"./chunk-KGCAX4NX.js";a();m();l();a();m();l();a();m();l();var G=v`
  div {
    width: 100%;
  }
...
`;var R=function(n,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,r);else for(var c=n.length-1;c>=0;c--)(s=n[c])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},E=class extends p{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return u`
    ...
    `}baseNameTemplate(){return u`<wui-text variant="paragraph-400" color="fg-200" class="base-name">
      ...
      >`:null}};E.styles=[L,X];R([S()],E.prototype,"errorMessage",void 0);R([S({type:Boolean})],E.prototype,"disabled",void 0);R([S()],E.prototype,"value",void 0);R([S({type:Boolean})],E.prototype,"loading",void 0);E=R([f("wui-ens-input")],E);a();m();l();var Q=v`
  wui-flex {
    width: 100%;
  }
...
`;var y=function(n,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,r);else for(var c=n.length-1;c>=0;c--)(s=n[c])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},w=class extends p{constructor(){super(),this.formRef=V(),this.usubscribe=[],this.name="",this.error="",this.loading=b.state.loading,this.suggestions=b.state.suggestions,this.registered=!1,this.profileName=T.state.profileName,this.onDebouncedNameInputChange=A.debounce(e=>{b.validateName(e)?(this.error="",this.name=e,b.getSuggestions(e),b.isNameRegistered(e).then(t=>{this.registered=t})):e.length<4?this.error="Name must be at least 4 characters long":this.error="Can only contain letters, numbers and - characters"}),this.usubscribe.push(b.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),T.subscribeKey("profileName",e=>{this.profileName=e,e&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return u`
      <wui-flex
    ...
    </wui-flex>`}isAllowedToSubmit(){return!this.loading&&!this.registered&&!this.error&&!this.profileName&&b.validateName(this.name)}async onSubmitName(){let e=H.state.activeChain;try{if(!this.isAllowedToSubmit())return;let t=`${this.name}${C.WC_NAME_SUFFIX}`;N.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:T.state.preferredAccountTypes?.[e]===_.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}}),await b.registerName(t),N.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:T.state.preferredAccountTypes?.[e]===_.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}})}catch(t){k.showError(t.message),N.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:T.state.preferredAccountTypes?.[e]===_.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:`${this.name}${C.WC_NAME_SUFFIX}`,error:t?.message||"Unknown error"}})}}onEnterKey(e){e.key==="Enter"&&this.isAllowedToSubmit()&&this.onSubmitName()}};w.styles=Q;y([S()],w.prototype,"errorMessage",void 0);y([x()],w.prototype,"name",void 0);y([x()],w.prototype,"error",void 0);y([x()],w.prototype,"loading",void 0);y([x()],w.prototype,"suggestions",void 0);y([x()],w.prototype,"registered",void 0);y([x()],w.prototype,"profileName",void 0);w=y([f("w3m-register-account-name-view")],w);a();m();l();a();m();l();var J=v`
...
`;var te=function(n,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,r);else for(var c=n.length-1;c>=0;c--)(s=n[c])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},D=class extends p{render(){return u`
      ...
      >
        ...
        <wui-link
          @click=${()=>{A.openHref(j.URLS.FAQ,"_blank")}}
        >
          Learn more
    ...
    </wui-flex>`}redirectToAccount(){P.replace("Account")}};D.styles=J;D=te([f("w3m-register-account-name-success-view")],D);export{$ as W3mApproveTransactionView,D as W3mRegisterAccountNameSuccess,w as W3mRegisterAccountNameView,q as W3mUpgradeWalletView};
