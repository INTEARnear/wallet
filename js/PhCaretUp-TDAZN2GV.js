import{a as d,b as f,c as r,d as u,e as y,f as a}from"./chunk-NHI5MHIS.js";import{i as m,k as n,o as c}from"./chunk-JY5TIRRF.js";m();c();n();var w=Object.defineProperty,M=Object.getOwnPropertyDescriptor,s=(o,l,i,p)=>{for(var e=p>1?void 0:p?M(l,i):l,h=o.length-1,g;h>=0;h--)(g=o[h])&&(e=(p?g(l,i,e):g(e))||e);return p&&e&&w(l,i,e),e},t=class extends u{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return f`<svg
  ...
  `;s([a({type:String,reflect:!0})],t.prototype,"size",2);s([a({type:String,reflect:!0})],t.prototype,"weight",2);s([a({type:String,reflect:!0})],t.prototype,"color",2);s([a({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([y("ph-caret-up")],t);export{t as PhCaretUp};
