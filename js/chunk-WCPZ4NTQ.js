import{a as l,b as N,g as T}from"./chunk-HILJYRBB.js";import{C as m,G as C,I as U,U as G,Y as R,Z as O,a as Y,l as _,m as V,q as z,s as F,z as W}from"./chunk-UDTBWQKV.js";import{b as A,e as a,j as D}from"./chunk-5RP2GFJC.js";import{h as p,j as u,n as d}from"./chunk-KGCAX4NX.js";p();d();u();p();d();u();p();d();u();p();d();u();var S;(function(r){r.approve="approved",r.bought="bought",r.borrow="borrowed",r.burn="burnt",r.cancel="canceled",r.claim="claimed",r.deploy="deployed",r.deposit="deposited",r.execute="executed",r.mint="minted",r.receive="received",r.repay="repaid",r.send="sent",r.sell="sold",r.stake="staked",r.trade="swapped",r.unstake="unstaked",r.withdraw="withdrawn"})(S||(S={}));p();d();u();p();d();u();var M=A`
  :host > wui-flex {
    display: flex;
...
`;var $=function(r,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,t,e,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i},w=class extends D{constructor(){super(...arguments),this.images=[],this.secondImage={type:void 0,url:""}}render(){let[t,e]=this.images,o=t?.type==="NFT",s=e?.url?e.type==="NFT":o,i=o?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)",n=s?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)";return this.style.cssText=`
    ...
    `,a`<wui-flex> ${this.templateVisual()} ${this.templateIcon()} </wui-flex>`}templateVisual(){let[t,e]=this.images,o=t?.type;return this.images.length===2&&(t?.url||e?.url)?a`<div class="swap-images-container">
      ...
      ></wui-icon-box>
    `:null}getDirectionIcon(){switch(this.direction){case"in":return"arrowBottom";case"out":return"arrowTop";default:return}}getIcon(){return this.onlyDirectionIcon?this.getDirectionIcon():this.type==="trade"?"swapHorizontalBold":this.type==="approve"?"checkmark":this.type==="cancel"?"close":this.getDirectionIcon()}getStatusColor(){switch(this.status){case"confirmed":return"success-100";case"failed":return"error-100";case"pending":return"inverse-100";default:return"accent-100"}}};w.styles=[M];$([l()],w.prototype,"type",void 0);$([l()],w.prototype,"status",void 0);$([l()],w.prototype,"direction",void 0);$([l({type:Boolean})],w.prototype,"onlyDirectionIcon",void 0);$([l({type:Array})],w.prototype,"images",void 0);$([l({type:Object})],w.prototype,"secondImage",void 0);w=$([O("wui-transaction-visual")],w);p();d();u();var P=A`
...
`;var f=function(r,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,t,e,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i},h=class extends D{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return a`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
    ...
    `}templateDescription(){let t=this.descriptions?.[0];return t?a`
        ...
        `:null}};h.styles=[G,P];f([l()],h.prototype,"type",void 0);f([l({type:Array})],h.prototype,"descriptions",void 0);f([l()],h.prototype,"date",void 0);f([l({type:Boolean})],h.prototype,"onlyDirectionIcon",void 0);f([l()],h.prototype,"status",void 0);f([l()],h.prototype,"direction",void 0);f([l({type:Array})],h.prototype,"images",void 0);f([l({type:Array})],h.prototype,"price",void 0);f([l({type:Array})],h.prototype,"amount",void 0);f([l({type:Array})],h.prototype,"symbol",void 0);h=f([O("wui-transaction-list-item")],h);p();d();u();var K=A`
  :host {
    min-height: 100%;
  }
...
`;var I=function(r,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,t,e,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i},j="last-transaction",Q=7,x=class extends D{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page="activity",this.caipAddress=C.state.activeCaipAddress,this.transactionsByYear=m.state.transactionsByYear,this.loading=m.state.loading,this.empty=m.state.empty,this.next=m.state.next,m.clearCursor(),this.unsubscribe.push(C.subscribeKey("activeCaipAddress",t=>{t&&this.caipAddress!==t&&(m.resetTransactions(),m.fetchTransactions(t)),this.caipAddress=t}),C.subscribeKey("activeCaipNetwork",()=>{this.updateTransactionView()}),m.subscribe(t=>{this.transactionsByYear=t.transactionsByYear,this.loading=t.loading,this.empty=t.empty,this.next=t.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return a` ${this.empty?null:this.templateTransactionsByYear()}
    ${this.loading?this.templateLoading():null}
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){let t=C.state.activeCaipNetwork?.caipNetworkId;m.state.lastNetworkInView!==t&&(m.resetTransactions(),this.caipAddress&&m.fetchTransactions(_.getPlainAddress(this.caipAddress))),m.setLastNetworkInView(t)}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(e=>{let o=parseInt(e,10),s=new Array(12).fill(null).map((i,n)=>{let c=R.getTransactionGroupTitle(o,n),g=this.transactionsByYear[o]?.[n];return{groupTitle:c,transactions:g}}).filter(({transactions:i})=>i).reverse();return s.map(({groupTitle:i,transactions:n},c)=>{let g=c===s.length-1;return n?a`
          <wui-flex
