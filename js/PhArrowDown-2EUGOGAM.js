import{a as d,b as w,c as r,d as f,e as u,f as a}from"./chunk-NHI5MHIS.js";import{i as g,k as m,o as c}from"./chunk-JY5TIRRF.js";g();c();m();var y=Object.defineProperty,v=Object.getOwnPropertyDescriptor,l=(o,i,p,s)=>{for(var e=s>1?void 0:s?v(i,p):i,h=o.length-1,n;h>=0;h--)(n=o[h])&&(e=(s?n(i,p,e):n(e))||e);return s&&e&&y(i,p,e),e},t=class extends f{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return w`<svg
  ...
  `;l([a({type:String,reflect:!0})],t.prototype,"size",2);l([a({type:String,reflect:!0})],t.prototype,"weight",2);l([a({type:String,reflect:!0})],t.prototype,"color",2);l([a({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([u("ph-arrow-down")],t);export{t as PhArrowDown};
