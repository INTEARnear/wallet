import{a as d,b as f,c as e,d as u,e as y,f as o}from"./chunk-NHI5MHIS.js";import{i as g,k as m,o as n}from"./chunk-JY5TIRRF.js";g();n();m();var w=Object.defineProperty,M=Object.getOwnPropertyDescriptor,i=(a,l,p,s)=>{for(var r=s>1?void 0:s?M(l,p):l,h=a.length-1,c;h>=0;h--)(c=a[h])&&(r=(s?c(l,p,r):c(r))||r);return s&&r&&w(l,p,r),r},t=class extends u{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return f`<svg
  ...
  `;i([o({type:String,reflect:!0})],t.prototype,"size",2);i([o({type:String,reflect:!0})],t.prototype,"weight",2);i([o({type:String,reflect:!0})],t.prototype,"color",2);i([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=i([y("ph-check")],t);export{t as PhCheck};
