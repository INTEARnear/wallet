import{a as d,b as w,c as r,d as A,e as f,f as a}from"./chunk-NHI5MHIS.js";import{i as g,k as m,o as c}from"./chunk-JY5TIRRF.js";g();c();m();var v=Object.defineProperty,u=Object.getOwnPropertyDescriptor,l=(o,s,h,i)=>{for(var e=i>1?void 0:i?u(s,h):s,p=o.length-1,n;p>=0;p--)(n=o[p])&&(e=(i?n(s,h,e):n(e))||e);return i&&e&&v(s,h,e),e},t=class extends A{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return w`<svg
  ...
  `;l([a({type:String,reflect:!0})],t.prototype,"size",2);l([a({type:String,reflect:!0})],t.prototype,"weight",2);l([a({type:String,reflect:!0})],t.prototype,"color",2);l([a({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([f("ph-arrow-clockwise")],t);export{t as PhArrowClockwise};
