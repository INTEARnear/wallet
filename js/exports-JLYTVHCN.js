...
`;var E=function(n,e,r,s){var o=arguments.length,i=o<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,r):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,r,s);else for(var m=n.length-1;m>=0;m--)(u=n[m])&&(i=(o<3?u(i):o>3?u(e,r,i):u(e,r))||i);return o>3&&i&&Object.defineProperty(e,r,i),i},h=class extends b{constructor(){super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=l.state.exchanges,this.isLoading=l.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=f.state.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(l.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(l.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(f.subscribe(e=>this.connectedWalletInfo=e.connectedWalletInfo)),l.fetchExchanges()}get isWalletConnected(){return f.state.status==="connected"}render(){return p`
    ...
    `}initializePaymentDetails(){let e=l.getPaymentAsset();this.networkName=e.network,this.tokenSymbol=e.metadata.symbol,this.amount=l.state.amount.toString()}renderPayWithWallet(){return q(this.networkName)?p`<wui-flex flexDirection="column" gap="s">
      ...
      <wui-separator text="or"></wui-separator>`:p``}renderPaymentHeader(){let e=this.networkName;if(this.networkName){let s=d.getAllRequestedCaipNetworks().find(o=>o.caipNetworkId===this.networkName);s&&(e=s.name)}return p`
    ...
    `}renderConnectedView(){let e=this.connectedWalletInfo?.name||"connected wallet";return p`
      ...
      >
        <wui-flex alignItems="center" gap="s">
          <wui-wallet-image
            size="sm"
            imageSrc=${U(this.connectedWalletInfo?.icon)}
            name=${U(this.connectedWalletInfo?.name)}
          ></wui-wallet-image>
    ...
    >
      ...
      `)}onWalletPayment(){l.handlePayWithWallet()}async onExchangePayment(e){try{this.loadingExchangeId=e;let r=await l.handlePayWithExchange(e);r&&(await g.open({view:"PayLoading"}),P.openHref(r.url,r.openInNewTab?"_blank":"_self"))}catch(r){console.error("Failed to pay with exchange",r),A.showError("Failed to pay with exchange")}finally{this.loadingExchangeId=null}}async onDisconnect(e){e.stopPropagation();try{await w.disconnect(),g.close()}catch{console.error("Failed to disconnect"),A.showError("Failed to disconnect")}}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}};h.styles=ee;E([y()],h.prototype,"amount",void 0);E([y()],h.prototype,"tokenSymbol",void 0);E([y()],h.prototype,"networkName",void 0);E([y()],h.prototype,"exchanges",void 0);E([y()],h.prototype,"isLoading",void 0);E([y()],h.prototype,"loadingExchangeId",void 0);E([y()],h.prototype,"connectedWalletInfo",void 0);h=E([v("w3m-pay-view")],h);var te=S`
  :host {
    display: block;
    height: 100%;
    width: 100%;
  }
`;var k=function(n,e,r,s){var o=arguments.length,i=o<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,r):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,r,s);else for(var m=n.length-1;m>=0;m--)(u=n[m])&&(i=(o<3?u(i):o>3?u(e,r,i):u(e,r))||i);return o>3&&i&&Object.defineProperty(e,r,i),i},ae=4e3,_=class extends b{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=l.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return p`
      <wui-flex
