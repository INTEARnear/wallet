import{a as Z,b as d,c as r,d as A,e as f,f as o}from"./chunk-NHI5MHIS.js";import{i as n,k as c,o as g}from"./chunk-JY5TIRRF.js";n();g();c();var v=Object.defineProperty,u=Object.getOwnPropertyDescriptor,s=(a,i,h,p)=>{for(var e=p>1?void 0:p?u(i,h):i,l=a.length-1,m;l>=0;l--)(m=a[l])&&(e=(p?m(i,h,e):m(e))||e);return p&&e&&v(i,h,e),e},t=class extends A{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;s([o({type:String,reflect:!0})],t.prototype,"size",2);s([o({type:String,reflect:!0})],t.prototype,"weight",2);s([o({type:String,reflect:!0})],t.prototype,"color",2);s([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([f("ph-clock")],t);export{t as PhClock};
