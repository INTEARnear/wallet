import{R as D,W as L}from"./chunk-WYPOXQ7L.js";import{a as B}from"./chunk-ZXNIRCPT.js";import{a as v}from"./chunk-HILJYRBB.js";import{b as A,e as R,f as E,j as Q}from"./chunk-5RP2GFJC.js";import{f as X,h as x,j as y,n as b}from"./chunk-KGCAX4NX.js";x();b();y();x();b();y();x();b();y();var q=X(B(),1);var F=.1,T=2.5,w=7;function z(l,r,h){return l===r?!1:(l-r<0?r-l:l-r)<=h+F}function P(l,r){let h=Array.prototype.slice.call(q.default.create(l,{errorCorrectionLevel:r}).modules.data,0),d=Math.sqrt(h.length);return h.reduce((p,u,f)=>(f%d===0?p.push([u]):p[p.length-1].push(u))&&p,[])}var U={generate({uri:l,size:r,logoSize:h,dotColor:d="#141414"}){let p="transparent",f=[],c=P(l,"Q"),s=r/c.length,O=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];O.forEach(({x:o,y:t})=>{let n=(c.length-w)*s*o,e=(c.length-w)*s*t,a=.45;for(let i=0;i<O.length;i+=1){let g=s*(w-i*2);f.push(E`
            <rect
              fill=${i===2?d:p}
              width=${i===0?g-5:g}
              rx= ${i===0?(g-5)*a:g*a}
