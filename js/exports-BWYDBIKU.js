...
`;var _=function(n,e,r,s){var o=arguments.length,i=o<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,r):s,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,r,s);else for(var h=n.length-1;h>=0;h--)(d=n[h])&&(i=(o<3?d(i):o>3?d(e,r,i):d(e,r))||i);return o>3&&i&&Object.defineProperty(e,r,i),i},N=class extends L{constructor(){super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=l.state.exchanges,this.isLoading=l.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=P.state.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(l.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(l.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(P.subscribe(e=>this.connectedWalletInfo=e.connectedWalletInfo)),l.fetchExchanges()}get isWalletConnected(){return P.state.status==="connected"}render(){return y`
    ...
    `}initializePaymentDetails(){let e=l.getPaymentAsset();this.networkName=e.network,this.tokenSymbol=e.metadata.symbol,this.amount=l.state.amount.toString()}renderPayWithWallet(){return te(this.networkName)?y`<wui-flex flexDirection="column" gap="s">
      ...
      <wui-separator text="or"></wui-separator>`:y``}renderPaymentHeader(){let e=this.networkName;if(this.networkName){let s=w.getAllRequestedCaipNetworks().find(o=>o.caipNetworkId===this.networkName);s&&(e=s.name)}return y`
    ...
    `}renderConnectedView(){let e=this.connectedWalletInfo?.name||"connected wallet";return y`
      ...
      >
        <wui-flex alignItems="center" gap="s">
          <wui-wallet-image
            size="sm"
            imageSrc=${D(this.connectedWalletInfo?.icon)}
            name=${D(this.connectedWalletInfo?.name)}
          ></wui-wallet-image>
    ...
    >
      ...
      `)}onWalletPayment(){l.handlePayWithWallet()}async onExchangePayment(e){try{this.loadingExchangeId=e;let r=await l.handlePayWithExchange(e);r&&(await x.open({view:"PayLoading"}),b.openHref(r.url,r.openInNewTab?"_blank":"_self"))}catch(r){console.error("Failed to pay with exchange",r),C.showError("Failed to pay with exchange")}finally{this.loadingExchangeId=null}}async onDisconnect(e){e.stopPropagation();try{await I.disconnect(),x.close()}catch{console.error("Failed to disconnect"),C.showError("Failed to disconnect")}}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}};N.styles=ie;_([f()],N.prototype,"amount",void 0);_([f()],N.prototype,"tokenSymbol",void 0);_([f()],N.prototype,"networkName",void 0);_([f()],N.prototype,"exchanges",void 0);_([f()],N.prototype,"isLoading",void 0);_([f()],N.prototype,"loadingExchangeId",void 0);_([f()],N.prototype,"connectedWalletInfo",void 0);N=_([M("w3m-pay-view")],N);u();m();p();u();m();p();var oe=O`
  :host {
    display: block;
    height: 100%;
    width: 100%;
  }
`;var V=function(n,e,r,s){var o=arguments.length,i=o<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,r):s,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,r,s);else for(var h=n.length-1;h>=0;h--)(d=n[h])&&(i=(o<3?d(i):o>3?d(e,r,i):d(e,r))||i);return o>3&&i&&Object.defineProperty(e,r,i),i},pe=4e3,U=class extends L{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=l.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return y`
      <wui-flex
