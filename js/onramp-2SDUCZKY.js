import"./chunk-J2AXCH7B.js";import"./chunk-N3OEVEIT.js";import"./chunk-ISS47DD4.js";import"./chunk-VD3CL2LB.js";import"./chunk-BVPCGFJI.js";import"./chunk-75RJCG2U.js";import"./chunk-YKZ2H6IE.js";import"./chunk-6YNROE26.js";import"./chunk-EYSHDOVL.js";import"./chunk-HNNCEA3D.js";import"./chunk-AFBE3D4S.js";import"./chunk-DEIPQ325.js";import"./chunk-ZIGIB2I5.js";import"./chunk-TH5JHSOM.js";import"./chunk-6OHO6DGB.js";import"./chunk-IXRLO5GV.js";import"./chunk-MLDJAIZD.js";import"./chunk-NSWQOQ7B.js";import{A as z,B as oe,D as O,E as X,F as _,H as A,I as d,M,V as se,W as w,a as ee,i as H,k as V,l as P,m as T,n as te,p as G,q as re,r as S,s as ie,y as Q,z as K}from"./chunk-WYPOXQ7L.js";import"./chunk-J6OVQL6H.js";import{a as h,b as m,g}from"./chunk-HILJYRBB.js";import"./chunk-ETAVA44A.js";import"./chunk-JK5MJGFP.js";import"./chunk-COAJKL54.js";import"./chunk-65GJ65H6.js";import"./chunk-H6T4G3YK.js";import"./chunk-FILZKAK2.js";import"./chunk-OZZRRPYE.js";import"./chunk-FXML5DPA.js";import"./chunk-6OI5GZ4U.js";import"./chunk-YRGGSJIG.js";import{b as v,e as l,j as f}from"./chunk-5RP2GFJC.js";import{h as c,j as u,n as p}from"./chunk-KGCAX4NX.js";c();p();u();c();p();u();c();p();u();c();p();u();var ne=v`
  :host {
    width: 100%;
  }
...
`;var Y=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},ge=7,L=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=d.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=z.state.coinbaseTransactions,this.tokenImages=T.state.tokenImages,this.unsubscribe.push(d.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),T.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},z.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),z.clearCursor(),this.fetchTransactions()}render(){return l`
...
`;var F=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},U=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=d.state.paymentCurrency,this.currencies=d.state.paymentCurrencies,this.currencyImages=T.state.currencyImages,this.checked=M.state.isLegalCheckboxChecked,this.unsubscribe.push(d.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),T.subscribeKey("currencyImages",e=>this.currencyImages=e),M.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:r}=P.state,i=P.state.features?.legalCheckbox,s=!!(e||r)&&!!i&&!this.checked;return l`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(r=>l`
      ...
      `)}selectCurrency(e){e&&(d.setPaymentCurrency(e),A.close())}};U.styles=le;F([m()],U.prototype,"selectedCurrency",void 0);F([m()],U.prototype,"currencies",void 0);F([m()],U.prototype,"currencyImages",void 0);F([m()],U.prototype,"checked",void 0);U=F([w("w3m-onramp-fiat-select-view")],U);c();p();u();c();p();u();c();p();u();var ce=v`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var ye=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},J=class extends f{render(){let{termsConditionsUrl:e,privacyPolicyUrl:r}=P.state;return!e&&!r?null:l`
    ...
    `}howDoesItWorkTemplate(){return l` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){let e=O.state.activeChain;G.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:_.state.preferredAccountTypes?.[e]===Q.ACCOUNT_TYPES.SMART_ACCOUNT}}),S.push("WhatIsABuy")}};J.styles=[ue];J=ye([w("w3m-onramp-providers-footer")],J);var pe=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},Z=class extends f{constructor(){super(),this.unsubscribe=[],this.providers=d.state.providers,this.unsubscribe.push(d.subscribeKey("providers",e=>{this.providers=e}))}firstUpdated(){let e=this.providers.map(async r=>r.name==="coinbase"?await this.getCoinbaseOnRampURL():Promise.resolve(r?.url));Promise.all(e).then(r=>{this.providers=this.providers.map((i,o)=>({...i,url:r[o]||""}))})}render(){return l`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
...
`;var q=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},B=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=d.state.purchaseCurrencies,this.tokens=d.state.purchaseCurrencies,this.tokenImages=T.state.tokenImages,this.checked=M.state.isLegalCheckboxChecked,this.unsubscribe.push(d.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),T.subscribeKey("tokenImages",e=>this.tokenImages=e),M.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:r}=P.state,i=P.state.features?.legalCheckbox,s=!!(e||r)&&!!i&&!this.checked;return l`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(r=>l`
      ...
      `)}selectToken(e){e&&(d.setPurchaseCurrency(e),A.close())}};B.styles=me;q([m()],B.prototype,"selectedCurrency",void 0);q([m()],B.prototype,"tokens",void 0);q([m()],B.prototype,"tokenImages",void 0);q([m()],B.prototype,"checked",void 0);B=q([w("w3m-onramp-token-select-view")],B);c();p();u();c();p();u();var de=v`
  @keyframes shake {
    0% {
...
`;var k=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},I=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=d.state.selectedProvider,this.uri=oe.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.startTime=null,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(d.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e})),this.watchTransactions()}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){let e="Continue in external window";this.error?e="Buy failed":this.selectedOnRampProvider&&(e=`Buy in ${this.selectedOnRampProvider?.label}`);let r=this.error?"Buy can be declined from your side or due to and error on the provider app":"We\u2019ll notify you once your Buy is processed";return l`
      <wui-flex
...
`;var W=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},N=class extends f{constructor(){super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=this.currencies?.[0],this.currencyImages=T.state.currencyImages,this.tokenImages=T.state.tokenImages,this.unsubscribe.push(d.subscribeKey("purchaseCurrency",e=>{!e||this.type==="Fiat"||(this.selectedCurrency=this.formatPurchaseCurrency(e))}),d.subscribeKey("paymentCurrency",e=>{!e||this.type==="Token"||(this.selectedCurrency=this.formatPaymentCurrency(e))}),d.subscribe(e=>{this.type==="Fiat"?this.currencies=e.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=e.paymentCurrencies.map(this.formatPaymentCurrency)}),T.subscribe(e=>{this.currencyImages={...e.currencyImages},this.tokenImages={...e.tokenImages}}))}firstUpdated(){d.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.selectedCurrency?.symbol||"",r=this.currencyImages[e]||this.tokenImages[e];return l`<wui-input-text type="number" size="lg" value=${this.value}>
    ...
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};N.styles=fe;W([h({type:String})],N.prototype,"type",void 0);W([h({type:Number})],N.prototype,"value",void 0);W([m()],N.prototype,"currencies",void 0);W([m()],N.prototype,"selectedCurrency",void 0);W([m()],N.prototype,"currencyImages",void 0);W([m()],N.prototype,"tokenImages",void 0);N=W([w("w3m-onramp-input")],N);c();p();u();var we=v`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
...
`;var D=function(n,e,r,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,i);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t},xe={USD:"$",EUR:"\u20AC",GBP:"\xA3"},ve=[100,250,500,1e3],E=class extends f{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=O.state.activeCaipAddress,this.loading=A.state.loading,this.paymentCurrency=d.state.paymentCurrency,this.paymentAmount=d.state.paymentAmount,this.purchaseAmount=d.state.purchaseAmount,this.quoteLoading=d.state.quotesLoading,this.unsubscribe.push(O.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),A.subscribeKey("loading",e=>{this.loading=e}),d.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    `}templateButton(){return this.caipAddress?l`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||A.open({view:"OnRampProviders"})}openModal(){A.open({view:"Connect"})}async onPaymentAmountChange(e){d.setPaymentAmount(Number(e.detail)),await d.getQuote()}async selectPresetAmount(e){d.setPaymentAmount(e),await d.getQuote()}};E.styles=we;D([h({type:Boolean})],E.prototype,"disabled",void 0);D([m()],E.prototype,"caipAddress",void 0);D([m()],E.prototype,"loading",void 0);D([m()],E.prototype,"paymentCurrency",void 0);D([m()],E.prototype,"paymentAmount",void 0);D([m()],E.prototype,"purchaseAmount",void 0);D([m()],E.prototype,"quoteLoading",void 0);E=D([w("w3m-onramp-widget")],E);export{I as W3mBuyInProgressView,L as W3mOnRampActivityView,Z as W3mOnRampProvidersView,U as W3mOnrampFiatSelectView,B as W3mOnrampTokensView,E as W3mOnrampWidget,he as W3mWhatIsABuyView};
