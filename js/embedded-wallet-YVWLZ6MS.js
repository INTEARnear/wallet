import"./chunk-D5NXUPZ3.js";import"./chunk-KW43YUNH.js";import"./chunk-N5247CTU.js";import"./chunk-5ECMN2P4.js";import"./chunk-FFVR7MOO.js";import"./chunk-6QYJVRH3.js";import"./chunk-NN4K4YIW.js";import"./chunk-KU4SZW5M.js";import"./chunk-JEGJJ3CB.js";import"./chunk-WQMDXFUC.js";import"./chunk-J4VZ2IKP.js";import"./chunk-37JX4LZT.js";import{D as P,F as b,H as A,L as f,R as z,W as u,b as x,f as U,h as W,i as C,k as y,p as S,r as D,s as R,t as j,y as E,z as M}from"./chunk-ORERQN7J.js";import{a as $,b as I}from"./chunk-QCS24RLY.js";import{a as g,b as p,g as O}from"./chunk-G6MGL5IE.js";import"./chunk-YDPF4UGR.js";import"./chunk-F3BT2OCD.js";import"./chunk-OIFNSKKM.js";import"./chunk-YY5EM6U5.js";import"./chunk-LHWHJQRC.js";import"./chunk-JJVWQEYF.js";import"./chunk-JGRP444H.js";import"./chunk-URLXKBQX.js";import"./chunk-FFQJ55XB.js";import"./chunk-6K56CBXQ.js";import{b as h,e as a,j as m}from"./chunk-WGWCH7J2.js";import"./chunk-57YRCRKT.js";var k=h`
  div {
    width: 100%;
  }
...
`;var v=function(n,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,r);else for(var l=n.length-1;l>=0;l--)(s=n[l])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},w=class extends m{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return a`
    ...
    `}baseNameTemplate(){return a`<wui-text variant="paragraph-400" color="fg-200" class="base-name">
      ...
      >`:null}};w.styles=[z,F];v([g()],w.prototype,"errorMessage",void 0);v([g({type:Boolean})],w.prototype,"disabled",void 0);v([g()],w.prototype,"value",void 0);v([g({type:Boolean})],w.prototype,"loading",void 0);w=v([u("wui-ens-input")],w);var B=h`
  wui-flex {
    width: 100%;
  }
...
`;var d=function(n,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,r);else for(var l=n.length-1;l>=0;l--)(s=n[l])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},c=class extends m{constructor(){super(),this.formRef=$(),this.usubscribe=[],this.name="",this.error="",this.loading=f.state.loading,this.suggestions=f.state.suggestions,this.registered=!1,this.profileName=b.state.profileName,this.onDebouncedNameInputChange=y.debounce(e=>{f.validateName(e)?(this.error="",this.name=e,f.getSuggestions(e),f.isNameRegistered(e).then(t=>{this.registered=t})):e.length<4?this.error="Name must be at least 4 characters long":this.error="Can only contain letters, numbers and - characters"}),this.usubscribe.push(f.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),b.subscribeKey("profileName",e=>{this.profileName=e,e&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return a`
      <wui-flex
        ...
        .padding=${["0","s","m","s"]}
      >
        <form ${I(this.formRef)} @submit=${this.onSubmitName.bind(this)}>
          <wui-ens-input
    ...
    </wui-flex>`}isAllowedToSubmit(){return!this.loading&&!this.registered&&!this.error&&!this.profileName&&f.validateName(this.name)}async onSubmitName(){let e=P.state.activeChain;try{if(!this.isAllowedToSubmit())return;let t=`${this.name}${x.WC_NAME_SUFFIX}`;S.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:b.state.preferredAccountTypes?.[e]===E.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}}),await f.registerName(t),S.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:b.state.preferredAccountTypes?.[e]===E.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:t}})}catch(t){M.showError(t.message),S.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:b.state.preferredAccountTypes?.[e]===E.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:`${this.name}${x.WC_NAME_SUFFIX}`,error:t?.message||"Unknown error"}})}}onEnterKey(e){e.key==="Enter"&&this.isAllowedToSubmit()&&this.onSubmitName()}};c.styles=B;d([g()],c.prototype,"errorMessage",void 0);d([p()],c.prototype,"name",void 0);d([p()],c.prototype,"error",void 0);d([p()],c.prototype,"loading",void 0);d([p()],c.prototype,"suggestions",void 0);d([p()],c.prototype,"registered",void 0);d([p()],c.prototype,"profileName",void 0);c=d([u("w3m-register-account-name-view")],c);var G=h`
...
`;var q=function(n,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,r);else for(var l=n.length-1;l>=0;l--)(s=n[l])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},_=class extends m{render(){return a`
      ...
      >
        ...
        <wui-link
          @click=${()=>{y.openHref(U.URLS.FAQ,"_blank")}}
        >
          Learn more
    ...
    </wui-flex>`}redirectToAccount(){D.replace("Account")}};_.styles=G;_=q([u("w3m-register-account-name-success-view")],_);export{T as W3mApproveTransactionView,_ as W3mRegisterAccountNameSuccess,c as W3mRegisterAccountNameView,V as W3mUpgradeWalletView};
