...
pub async fn get_protocols() -> Vec<Protocol> {
    ...
    static PROTOCOLS: &[ProtocolDefinition] = &[
        ...
        ProtocolDefinition {
            ...
            name_override: None,
            description: "The largest DEX & Lending platform on NEAR",
            url_override: None,
            image_override: None,
        },
        ProtocolDefinition {
        ...
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "Cross-chain exchange",
            url_override: None,
            image_override: None,
        },
        ProtocolDefinition {
            project_id: "templar-protocol",
            category: ProtocolCategory::DeFi,
            is_sponsored: false,
            size: ProtocolSize::Small,
            name_override: None,
            description: "BTC & STNEAR Lending protocol",
            url_override: None,
            image_override: None,
        },
        // NFTs
        ...
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "The Chain-Abstracted Liquidity Solution",
            url_override: None,
            image_override: None,
        },
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "USDC lending with Bitcoin collateral",
            url_override: None,
            image_override: None,
        },
        // Memecoins
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "One of the biggest OG memes on NEAR",
        ...
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "The first meme on NEAR, builders of Meme Cooking",
        ...
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "JAMBO JAMBO JAMBO JAMBO JAMBO JAMBO JAMBO JAMBO JAMBO",
            url_override: None,
            image_override: None,
        },
        // Launchpad
        ...
        ProtocolDefinition {
            project_id: "calyx-a-near-intents-launchpad",
            category: ProtocolCategory::Launchpad,
            is_sponsored: false,
            size: ProtocolSize::Small,
            name_override: Some("Calyx"),
            description: "a NEAR-Intents Launchpad (permissioned)",
            url_override: None,
            image_override: None,
        },
        // AI
        ...
        ProtocolDefinition {
            ...
            is_sponsored: true,
            size: ProtocolSize::Small,
            name_override: Some("Intear"),
            description: "Telegram AI Moderator, agents, AI oracles",
            url_override: Some("https://intea.rs"),
            image_override: None,
        },
        ProtocolDefinition {
            project_id: "curate-fun-%ef%b8%8f-autonomous-news",
            category: ProtocolCategory::Ai,
            is_sponsored: false,
            size: ProtocolSize::Small,
            name_override: None,
        ...
        ProtocolDefinition {
            project_id: "learnai-learn-near-club-ai",
            category: ProtocolCategory::Ai,
            is_sponsored: false,
            size: ProtocolSize::Small,
            name_override: None,
            description: "Ask anything about NEAR and NEAR ecosystem",
            url_override: None,
            image_override: None,
        },
        ProtocolDefinition {
            ...
            size: ProtocolSize::Small,
            name_override: None,
            description: "Earn by creating training data for AI",
            url_override: None,
            image_override: None,
        },
        // Explorer
        ...
        ProtocolDefinition {
            project_id: "intear-trade",
            category: ProtocolCategory::Explorer,
            is_sponsored: true,
            size: ProtocolSize::Small,
            name_override: None,
            description: "See chart, recent trades, token information",
            url_override: None,
            image_override: None,
        },
        // Bots
        ...
        ProtocolDefinition {
            project_id: "degen-arena",
            category: ProtocolCategory::Game,
            is_sponsored: false,
            size: ProtocolSize::Small,
            name_override: None,
            description: "Crypto casino and prediction markets",
            url_override: None,
            image_override: None,
        },
        // Social
        ...
        ProtocolDefinition {
            project_id: "near-ai-legion",
            category: ProtocolCategory::Social,
            is_sponsored: false,
            size: ProtocolSize::Large,
            name_override: None,
            description: "Prepare for ASI - Find NEARvana ",
            url_override: None,
            image_override: None,
        },
        ProtocolDefinition {
        ...
        ProtocolDefinition {
            ...
            size: ProtocolSize::Large,
            name_override: None,
            description: "Gigs Marketplace Platform for the NEAR Ecosystem",
            url_override: None,
            image_override: None,
        },
    ];
